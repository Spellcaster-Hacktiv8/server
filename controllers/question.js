...
class Controller {
    static read(req, res) {
        ...
        {
            q5: 'Have you recently started experiencing any of these symptoms ?',
            description: ['Fever or chills','Mild or moderate difficulty breathing', 'New or worsening cough', 'Sustained loss of smell, taste, or appetite', 'sore throat','etc'],
            answer: ['YES', 'None of the above']
        },
        {
            q6: 'Do any of these apply to you ?',
        ...
        {
            q7: 'In the last 14 days, have you traveled internationally',
            description: [''],
            answer: ['I have traveled internationally', 'I have not traveled internationally']
        },
        {
            q8: 'In the last 14 days, have you been in an area where COVID-19 is widwspread ?',
            description: [''],
            answer: ['I Live in an area where Covid-19 is widespread', 'None of above']
        },
        {
            q9: 'In the last 14 days, what is your exposure to others who are known to have COVID-19 ?',
            description: [''],
